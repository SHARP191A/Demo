...
function createPieChart() {
  ...
  var dateFilter = document.getElementById("dateFilterOptions");
  currentValue = data.options[data.selectedIndex].value;
  dateFilter = dateFilter.options[dateFilter.selectedIndex].value;
  console.log(dateFilter);
  makePieChart("chartdiv", currentValue, dateFilter);
}
